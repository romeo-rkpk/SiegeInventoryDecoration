...
class DanchuGUIContainer(inventorySlotsIn: Container) : ContainerGUIAbstract(inventorySlotsIn){
    override fun texture(): ResourceLocation {
        return ResourceLocation(SiegeInventoryDecoration.MOD_ID, "danchu.png")
    }
}